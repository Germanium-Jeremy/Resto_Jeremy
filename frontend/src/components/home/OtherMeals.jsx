...
const OtherMeals = () => {
     ...
     return (
          ...
          <h1 className={`text-xl md:text-2xl text-center font-bold`}>We provide additional lunch and supper meal.</h1>
                    ...
                    return (
                         <div className={`w-full h-[4cm] rounded-xl bg-slate-50`}>
                              ...
                              <div className={`flex max-[340px]:flex-col justify-between items-center w-full px-[.3rem]`}>
                                   ...
                                   <button className={`bg-amber-600 hover:bg-amber-500 text-white p-[.4rem] px-[.8rem] text-xl font-bold rounded-full max-[340px]:w-full max-[340px]:rounded-lg max-[340px]:p-0`}>+</button>
                              </div>
                         </div>
                    )
               })}
